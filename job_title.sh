...
# ---------------------------------
# TEXAS TECH HPCC A100: nocona launcher/CPU, toreador GPU
# ---------------------------------
  hpcc:env)
    JOB_NAME="env_setup"
    PARTITION=$CPU
  ...
  hpcc:traditional)
    JOB_NAME="Traditional_student_training_a100"
    PARTITION=$GPU
    NODES="1"
    GPUS_PER_NODE="1"
    CPUS_PER_TASK="6"
  ...
  hpcc:ept_student)
    JOB_NAME="ept_${SAFE_STUDENT_NAME}_base_a100"
    PARTITION=$GPU
    NODES="1"
    GPUS_PER_NODE="1"
    CPUS_PER_TASK="6"
  ...
  hpcc:ept_teacher)
    JOB_NAME="ept_${SAFE_TEACHER_NAME}_base_a100"
    PARTITION=$GPU
    NODES="1"
    GPUS_PER_NODE="3"
    CPUS_PER_TASK="16"
  ...
  hpcc:ept_trad_student)
    JOB_NAME="ept_trad_student_sft_a100"
    PARTITION=$GPU
    NODES="1"
    GPUS_PER_NODE="1"
    CPUS_PER_TASK="6"
  ...
  hpcc:traditional_eval)
    JOB_NAME="Traditional_${SAFE_STUDENT_NAME}_harness_a100"
    PARTITION=$GPU
    NODES="1"
    GPUS_PER_NODE="1"
    CPUS_PER_TASK="6"
  ...
  hpcc:teacher_harness)
    JOB_NAME="base_${SAFE_TEACHER_NAME}_harness_a100"
    PARTITION=$GPU
    NODES="1"
    GPUS_PER_NODE="3"
    CPUS_PER_TASK="16"
  ...
  hpcc:student_harness)
    JOB_NAME="base_${SAFE_STUDENT_NAME}_harness_a100"
    PARTITION=$GPU
    NODES="1"
    GPUS_PER_NODE="1"
    CPUS_PER_TASK="6"
  ...
  *)
    ...
    echo "  bash submit.sh hpcc build_feature_cache"
    echo "  bash submit.sh hpcc build_relation_cache"
    echo "  bash submit.sh hpcc build_response_cache"
    echo "  bash submit.sh hpcc feature"
    echo "  bash submit.sh hpcc relation"
    echo "  bash submit.sh hpcc response"
    echo "  bash submit.sh hpcc ept_student"
    echo "  bash submit.sh hpcc ept_teacher"
    echo "  bash submit.sh hpcc teacher_harness"
    echo "  bash submit.sh hpcc student_harness"
    exit 1
    ;;
esac
